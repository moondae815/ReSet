...
| :--- | ---: |
| 다중 레거시 SP 단계 수 | 0 |
| SP 표에는 있는데 단계에 없는 코드가 있는 단계 수 | 103 |
...
| 분모 | 값 |
| :--- | ---: |
| 앵커가 서수로 해결된 문장 수 | 814 |
| 앵커는 있으나 서수로 환산되지 않은 문장 수 | 0 |
| (Kind, Ordinal) 모호성 가드가 버린 문장 수 | 0 |
| 원본에 있는데 이행 최상위에 없는 조인 짝 수 (발화 아님) | 193 |
| 계보 원천을 가진 문장 수 | 2 |
| 스테이징만 읽어 검사 C 가 면제한 문장 수 | 2 |
| 자기 대상을 읽는 문장 수 | 378 |
| 자기 대상을 읽어 스테이징 면제가 취소된 문장 수 | 0 |
| 하위 범위 술어 컬럼을 가진 문장 수 | 103 |
| 하위 범위 술어 컬럼의 총수 | 1772 |
| 스테이징 원천의 총수 | 2 |
| 최상위 술어 - 원본과 대조까지 간 앵커 DML 문장 수 | 737 |
| 최상위 술어 - 발화한 문장 수 | 2 |
| 최상위 술어 - 원본 DDL 이 없어 침묵(S1) | 0 |
| 최상위 술어 - 원본에 키가 없거나 모호해 침묵(S2) | 0 |
| 최상위 술어 - 원본 문장에 최상위 항이 없어 침묵(S3) | 61 |
