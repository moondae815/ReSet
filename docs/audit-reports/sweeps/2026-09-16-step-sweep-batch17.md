...
- 단계 파일 누락: 0
- 목차 파싱 실패 Job: 없음
- 단계 번들 세대: 2026-09-04 ~ 2026-09-16
- 명세서 세대: 2026-09-10
- 미해결 프로시저 참조: 0
- 측정 쌍 0인 Job: 없음
...
| :--- | ---: |
| 다중 레거시 SP 단계 수 | 1 |
| SP 표에는 있는데 단계에 없는 코드가 있는 단계 수 | 146 |
...
| 하위 범위 술어 컬럼을 가진 문장 수 | 155 |
| 하위 범위 술어 컬럼의 총수 | 2617 |
| 스테이징 원천의 총수 | 4 |
| 최상위 술어 - 원본과 대조까지 간 앵커 DML 문장 수 | 1053 |
| 최상위 술어 - 발화한 문장 수 | 2 |
| 최상위 술어 - 원본 DDL 이 없어 침묵(S1) | 0 |
| 최상위 술어 - 원본에 키가 없거나 모호해 침묵(S2) | 8 |
| 최상위 술어 - 원본 문장에 최상위 항이 없어 침묵(S3) | 89 |
| 최상위 술어 - 커서 그룹 면제(E2) | 22 |
