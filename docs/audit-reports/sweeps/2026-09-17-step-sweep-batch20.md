...
| :--- | ---: |
| 다중 레거시 SP 단계 수 | 1 |
| SP 표에는 있는데 단계에 없는 코드가 있는 단계 수 | 179 |
...
| 하위 범위 술어 컬럼을 가진 문장 수 | 193 |
| 하위 범위 술어 컬럼의 총수 | 3239 |
| 스테이징 원천의 총수 | 4 |
| 최상위 술어 - 원본과 대조까지 간 앵커 DML 문장 수 | 1302 |
| 최상위 술어 - 발화한 문장 수 | 2 |
| 최상위 술어 - 원본 DDL 이 없어 침묵(S1) | 0 |
| 최상위 술어 - 원본에 키가 없거나 모호해 침묵(S2) | 8 |
| 최상위 술어 - 원본 문장에 최상위 항이 없어 침묵(S3) | 110 |
| 최상위 술어 - 커서 그룹 면제(E2) | 28 |
