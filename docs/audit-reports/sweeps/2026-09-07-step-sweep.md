...
**이 판은 `POQSettleBatch3`(생성 실패 스텁 26 단계)가 아직 있는 상태다 — 측정 쌍 76 / Job 4.
대조판은 `2026-09-07-step-sweep-b.md`(Batch3 제거, 측정 쌍 50 / Job 3)이고, 둘의 차가
Batch3 몫이다. 판독: `../2026-09-07-Batch3-코퍼스-제거-판독.md`.**

## 실행 조건

- 커밋: `baf19ea1`
- 작업 트리: 깨끗
- 캐시 인덱스 `FormatVersion` 집합: {18, 19} — 항목 31개
- 측정 쌍: 76 (Job 4개)
- 단계 파일 누락: 0
- 목차 파싱 실패 Job: 없음
- 단계 번들 세대: 2026-09-04 ~ 2026-09-06
- 명세서 세대: 2026-09-05 ~ 2026-09-07
- 미해결 프로시저 참조: 0
- 측정 쌍 0인 Job: 없음
...
| POQSettleBatch1 | 미분류 | 7 | 7 |
| POQSettleBatch3 | A | 42 | 42 |
| POQSettleBatch3 | 미분류 | 270 | 270 |
...
| :--- | ---: |
| 다중 레거시 SP 단계 수 | 0 |
| SP 표에는 있는데 단계에 없는 코드가 있는 단계 수 | 49 |
