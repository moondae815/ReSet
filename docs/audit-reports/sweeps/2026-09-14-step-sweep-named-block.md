...
- 단계 파일 누락: 0
- 목차 파싱 실패 Job: 없음
- 단계 번들 세대: 2026-09-04 ~ 2026-09-14
- 명세서 세대: 2026-09-10
- 미해결 프로시저 참조: 0
- 측정 쌍 0인 Job: 없음
...
| POQSettleBatch1 | 미분류 | 12 | 12 |
| POQSettleBatch10 | 미분류 | 9 | 9 |
| POQSettleBatch11 | 미분류 | 7 | 7 |
| POQSettleBatch12 | 미분류 | 5 | 5 |
| POQSettleBatch13 | 미분류 | 5 | 5 |
| POQSettleBatch14 | 미분류 | 1 | 1 |
| POQSettleBatch15 | 미분류 | 3 | 3 |
| POQSettleBatch16 | 미분류 | 4 | 4 |
| POQSettleBatch4 | C | 1 | 1 |
| POQSettleBatch4 | P | 1 | 1 |
| POQSettleBatch4 | 미분류 | 4 | 4 |
| POQSettleBatch5 | 미분류 | 9 | 9 |
| POQSettleBatch7 | P | 1 | 1 |
| POQSettleBatch7 | 미분류 | 2 | 2 |
| POQSettleBatch8 | 미분류 | 12 | 12 |
...
| :--- | ---: |
| 다중 레거시 SP 단계 수 | 1 |
| SP 표에는 있는데 단계에 없는 코드가 있는 단계 수 | 135 |
...
| 분모 | 값 |
| :--- | ---: |
| 앵커가 서수로 해결된 문장 수 | 1090 |
| 앵커는 있으나 서수로 환산되지 않은 문장 수 | 0 |
| (Kind, Ordinal) 모호성 가드가 버린 문장 수 | 0 |
| 원본에 있는데 이행 최상위에 없는 조인 짝 수 (발화 아님) | 246 |
| 계보 원천을 가진 문장 수 | 3 |
| 스테이징만 읽어 검사 C 가 면제한 문장 수 | 2 |
| 자기 대상을 읽는 문장 수 | 508 |
| 자기 대상을 읽어 스테이징 면제가 취소된 문장 수 | 1 |
| 하위 범위 술어 컬럼을 가진 문장 수 | 139 |
| 하위 범위 술어 컬럼의 총수 | 2386 |
| 스테이징 원천의 총수 | 3 |
| 최상위 술어 - 원본과 대조까지 간 앵커 DML 문장 수 | 970 |
| 최상위 술어 - 발화한 문장 수 | 2 |
| 최상위 술어 - 원본 DDL 이 없어 침묵(S1) | 0 |
| 최상위 술어 - 원본에 키가 없거나 모호해 침묵(S2) | 8 |
| 최상위 술어 - 원본 문장에 최상위 항이 없어 침묵(S3) | 82 |
| 최상위 술어 - 커서 그룹 면제(E2) | 20 |
