...
- 단계 파일 누락: 0
- 목차 파싱 실패 Job: 없음
- 단계 번들 세대: 2026-09-04 ~ 2026-09-12
- 명세서 세대: 2026-09-10
- 미해결 프로시저 참조: 0
- 측정 쌍 0인 Job: 없음
...
| :--- | ---: |
| 다중 레거시 SP 단계 수 | 0 |
| SP 표에는 있는데 단계에 없는 코드가 있는 단계 수 | 59 |
