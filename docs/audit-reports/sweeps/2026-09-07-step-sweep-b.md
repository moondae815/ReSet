...
**이 판이 현행 기준선이다 — `POQSettleBatch3` 제거 후(측정 쌍 50 / Job 3).
같은 커밋의 제거 전 판은 `2026-09-07-step-sweep.md`(측정 쌍 76 / Job 4).
판독: `../2026-09-07-Batch3-코퍼스-제거-판독.md`.**

## 실행 조건

- 커밋: `baf19ea1`
- 작업 트리: **더러움** (변경된 파일 1개) — 이 수치는 커밋되지 않은 코드가 낸 것이다
...
| :--- | ---: |
| 다중 레거시 SP 단계 수 | 0 |
| SP 표에는 있는데 단계에 없는 코드가 있는 단계 수 | 33 |
