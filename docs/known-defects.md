...
읽던 자리**가 드러나 아래 첫 건이 섰다. **그 뒤 축 B 재감사(2026-09-05)가 셋을 더 세웠다** — 그중 청크 Few-Shot 은 같은 날 원인을 닫았으므로(`7feb3c54`) **넷 중 셋이 「원인은 닫혔고 배송본은 안 닫혔다」는 같은 모양이다.**
...
### 자리가 좁혀졌다가 닫힌 것 — 2026-09-02 ~ 09-04

**여기만은 요약하지 않는다.** 여섯 건 다 실측 수치가 근거이고, 그 수치를 지우면
