...
정책 결정도 실측도 아니고 코드 변경만 남았다. 아래 표의 취소선은 기록이다. 뒤의 둘은
**두 오라클이 서로 반대를 말하는** 부류였고, 그 상태에서 검사나 지표를 넓히면 오탐만
늘어난다는 것을 보여 준 자리다(`check-oracle-provenance`). 앞의 셋은 2026-09-04에 닫혔고,
첫 항목의 요지는 하나다 — **예산이 모자란 것이 아니라 재생성이 그 위반에 닿지 못했다.**
