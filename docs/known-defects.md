...
- **캐시 17 인상 전 선결 조건 — I2·I3·재매핑 위험을 한 자리에 모은다(2026-08-25,
  ...
  **실측(통제 대조 스윕, `fe89b5d` → 이 커밋, `docs/audit-reports/sweeps/
  2026-08-27-step-sweep-b.md`).** 검사 B 34 → 26, 검사 C 25 → 20, 합계
  59 → 46. 사라진 15건 중 13건이 위 부류 3·5의 좌표(부류 3의 8/9건, 부류 5의
  5/6건)이고, 새로 생긴 것 3건은 부류 3·5가 **아니라** 아래 부류 4
  (`POQSettleProc9/S13`)의 부수 효과다 — 자세한 원인은 부류 4 문단에 적는다.
