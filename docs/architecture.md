...
graph TD
    ...
    subgraph Agentic ["2. 3단계 Agentic Workflow (생성)"]
        ...
        StepGen --> StepFloor{"단계 하한 검사<br/>(SQL/의사코드·대상테이블·오류코드·조건컬럼·축약어)"}
