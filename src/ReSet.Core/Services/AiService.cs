...
9. [Error Codes] You MUST strictly reuse the EXACT original error codes from the source SPs (steps with no legacy origin follow rule 6-2 instead). DO NOT remap or invent new error codes (e.g., changing -1 to -11). DO NOT use continuous ranges (e.g., `-1~-23`).
