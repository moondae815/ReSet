...
{checklistSb}";
        ...
        ///   `GOTO`는 0건이었으므로 모델이 스스로 되돌린 것이고, 막는 조항이 규칙에도
        ///   채점에도 없었다. 이번에는 규칙 6-1이 아니라 **규칙 3-1(SQL 거처)**에
